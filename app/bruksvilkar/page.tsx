...
export default function Bruksvilkar() {
  return <main className="min-h-screen bg-slate-100 text-slate-900"><Navigasjon />
    <header className="bg-slate-950 px-4 py-16 text-white sm:px-6"><div className="mx-auto max-w-4xl"><p className="font-semibold text-emerald-400">VILKÅR</p><h1 className="mt-3 text-4xl font-bold sm:text-5xl">Bruksvilkår</h1><p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">Kort om hva du kan forvente av tjenesten, og hva du selv må kontrollere.</p><p className="mt-5 text-sm text-slate-400">Sist oppdatert: 6. september 2026</p></div></header>
    <section className="px-4 py-10 sm:px-6"><div className="mx-auto max-w-4xl space-y-5">
      <Kort tittel="1. Om tjenesten"><p>Eiendomsoversikten er et digitalt hjelpemiddel for boligeiere og utleiere. Tjenesten samler blant annet boliginformasjon, oppussing, vedlikehold, dokumenter, leietakere, kontrakter, økonomi, kalender og rapporter. Tjenesten er foreløpig i beta og kan bli endret underveis.</p></Kort>
      ...
      <Kort tittel="7. Digital boligoverlevering"><p>Boligoverlevering er bare tilgjengelig for boliger registrert som privat bolig. Selgeren er ansvarlig for å kontrollere mottakerens e-postadresse og innholdet før invitasjonen opprettes. Valgte boligopplysninger og dokumenter flyttes til kjøperen når invitasjonen godtas. Lån, skatt, leietakere, personlige notater og sikkerhetskoder skal ikke overføres. Selgeren bør beholde egen arkivkopi av nødvendig dokumentasjon.</p></Kort>
      <Kort tittel="8. Ansvar"><p>Vi er ansvarlige i den utstrekning det følger av ufravikelig lov. Vi er ikke ansvarlige for beslutninger som tas utelukkende på grunnlag av veiledende beregninger eller ukontrollerte brukerdata. Ingenting i vilkårene begrenser rettigheter du har etter ufravikelig norsk forbrukerlovgivning.</p></Kort>
      <Kort tittel="9. Sletting og avslutning"><p>Du kan slutte å bruke tjenesten og slette kontoen under Min konto. Vi kan begrense tilgang ved alvorlig misbruk, ulovlig bruk eller sikkerhetstrusler. Data behandles og slettes som beskrevet i personvernerklæringen.</p></Kort>
      <Kort tittel="10. Personvern"><p>Les <Link href="/personvern" className="font-semibold text-emerald-700">personvernerklæringen</Link> for informasjon om hvilke personopplysninger vi behandler, formål, lagring og rettighetene dine.</p></Kort>
      <Kort tittel="11. Kontakt og lovvalg"><p>Spørsmål kan sendes til <a href="mailto:eiendomsoversikten@gmail.com" className="font-semibold text-emerald-700">eiendomsoversikten@gmail.com</a>. Vilkårene følger norsk rett. En eventuell tvist søkes først løst i dialog, uten at dette begrenser lovfestede klage- eller domstolsrettigheter.</p></Kort>
