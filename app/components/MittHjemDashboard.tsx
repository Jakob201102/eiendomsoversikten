...
type HistorikkSkjema = { tittel: string; dato: string; omrade: string; romId: string; kostnad: string; utfortAv: "selv" | "firma"; firma: string; handverkerId: string; nyHandverkerNavn: string; beskrivelse: string };
...
const tomHistorikk: HistorikkSkjema = { tittel: "", dato: new Date().toISOString().slice(0, 10), omrade: "", romId: "", kostnad: "", utfortAv: "selv", firma: "", handverkerId: "", nyHandverkerNavn: "", beskrivelse: "" };
