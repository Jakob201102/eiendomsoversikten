...
export default function Boligveileder({ kompakt = false }: { kompakt?: boolean }) {
  ...
  return <>
    <button type="button" onClick={start} className={kompakt ? "rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-2.5 text-sm font-bold text-emerald-800" : "rounded-xl border border-white/30 px-5 py-3 font-bold text-white hover:bg-white/10"}>🧭 Vis boligveileder</button>
