...
export default function Navigasjon() {
  ...
  useEffect(() => {
    const privatSide = pathname === "/mitt-hjem" || pathname === "/rom" || pathname === "/kontakter" || pathname === "/garantier" || pathname === "/forsikringer";
