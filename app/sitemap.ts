...
export default function sitemap(): MetadataRoute.Sitemap {
  const sider = [
    ...
    { sti: "/mitt-hjem", prioritet: 0.8, frekvens: "monthly" as const },
    { sti: "/rom", prioritet: 0.7, frekvens: "monthly" as const },
    ...
    { sti: "/garantier", prioritet: 0.7, frekvens: "monthly" as const },
